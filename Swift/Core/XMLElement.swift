 ...
 */
public extension KissXML.XMLElement {
    
    // MARK: Extracting a single element.
    
    func element(forName name: String) -> KissXML.XMLElement? {
        let elements = self.elements(forName: name)
        return elements.first
    }
    
    func element(forName name: String, xmlns: String) -> KissXML.XMLElement? {
